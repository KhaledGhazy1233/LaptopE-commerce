...
namespace Tech.DataAccess.Migrations
{
    ...
    [Migration("20250512171824_WishListAndWishListItem")]
    partial class WishListAndWishListItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tech.Models.Models.Discount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsCompitaple")
                        .HasColumnType("bit");

                    b.Property<double>("Presentage")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TechProject.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Tech.Models.Models.OrderDetails", b =>
                {
                    b.HasOne("Tech.Models.Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("Tech.Models.Models.WishListItem", b =>
                {
                    ...
                    b.HasOne("Tech.Models.Models.WishList", "Wishlist")
